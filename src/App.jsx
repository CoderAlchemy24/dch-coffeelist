...
function App() {
  ...
  return (
    <>
      ...
      <main className='w-[84%] max-w-6xl mx-auto z-[5] relative -mt-60 mb-48 pb-24 bg-[#111315] rounded-lg p-8 shadow-lg bg-[url("/resources/vector.svg")] bg-no-repeat bg-[length:300px] bg-[position:top_1rem_right_11rem]'>
